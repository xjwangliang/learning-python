...
public class TqlTaobaoClient {
	...
	public TqlTaobaoClient(String serverUrl, String appKey, String appSecret, String format) {
		this.format = format;
		this.appSecret = appSecret;
		client = new DefaultTaobaoClient(serverUrl, appKey, appSecret, format);
	}

	public TqlTaobaoClient(String serverUrl, String appKey, String appSecret, String format, int connectTimeout,
			int readTimeout) {
		this.format = format;
		this.appSecret = appSecret;
		client = new DefaultTaobaoClient(serverUrl, appKey, appSecret, format, connectTimeout, readTimeout);
	}
	...
	public TqlTaobaoClient(String serverUrl, String appKey, String appSecret, String format, int connectTimeout,
		...
		this.format = format;
		this.appSecret = appSecret;
		client = new DefaultTaobaoClient(serverUrl, appKey, appSecret, format, connectTimeout, readTimeout, signMethod);
	}
